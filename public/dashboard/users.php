...
<section class="review-card"><div class="card-heading"><h2>Team accounts</h2><a class="button button-secondary" href="<?= dashboard_h(shan_dashboard_base()) ?>users.php?new=1#account-editor">Add user +</a></div>
<div class="user-list"><?php foreach($users as $u): ?><a class="user-item <?= $id===(int)$u['id']?'is-selected':'' ?>" href="?id=<?= (int)$u['id'] ?>#account-editor"><span><strong><?= dashboard_h($u['display_name']) ?></strong><small><?= dashboard_h($u['email']) ?></small><small><?= dashboard_h($presets[$u['role']]['label'] ?? $u['role']) ?></small></span><span class="type-pill"><?= $u['active']?'Active':'Disabled' ?></span></a><?php endforeach; ?></div></section>
<section class="review-card" id="account-editor"><div class="card-heading"><h2><?= $id?'Edit account':'Create account' ?></h2></div>
