...
const questions = [
  ...
  ['How are website inquiries managed?', 'Website forms are submitted securely inside the site, stored for authorized review and routed to the appropriate business or HR mailbox.'],
];
