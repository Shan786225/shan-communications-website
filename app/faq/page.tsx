...
const questions = [
  ...
  ['How will website inquiries be managed?', 'Website forms are submitted directly inside the site and notify the appropriate business or HR mailbox. Database storage, Google Sheets mirroring and an authenticated dashboard are planned as a separate backend phase.'],
];
