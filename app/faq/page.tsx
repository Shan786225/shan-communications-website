...
const questions = [
  ...
  ['How will website inquiries be managed?', 'The planned production workflow will record inquiries in the Shan database, mirror them to Google Sheets, notify the support email and make them available in a secure admin dashboard.'],
];
